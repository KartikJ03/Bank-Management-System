...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        r4 = new JRadioButton("Reccuring Desposit Account");
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-5563");
        ...
        JLabel services = new JLabel("Servives Required");
        ...
        c7 = new JCheckBox("I hereby declare that the above entered details are the correct to the best of my knowledge");
        c7.setBackground(Color.WHITE);
        c7.setFont(new Font("Raleway",Font.BOLD,12));
        c7.setBounds(100,585,600,30);
        add(c7);
